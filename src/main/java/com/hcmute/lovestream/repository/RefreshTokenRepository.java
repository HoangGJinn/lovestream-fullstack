...
public interface RefreshTokenRepository extends JpaRepository<RefreshToken, Long> {
    ...
    @Modifying
    @Query("UPDATE RefreshToken r SET r.revoked = true WHERE r.user.id = :userId AND r.deviceId = :deviceId AND r.revoked = false")
    void revokeUserTokensByDeviceId(@Param("userId") String userId, @Param("deviceId") String deviceId);
