    ...
    public Map<String, Object> getDashboardStatistics() {
        ...
        List<Payment> successPayments = allPayments.stream()
                .filter(p -> p.getStatus() != null &&
                        (p.getStatus().name().equals("SUCCESS") || p.getStatus().name().equals("COMPLETED")))
        ...
        Map<String, Long> planDistribution = successPayments.stream()
                ...
                .collect(Collectors.groupingBy(p -> p.getServicePlan().getName(), Collectors.counting()));
        ...
        List<Map<String, Object>> recentTransactions = successPayments.stream()
                ...
                .map(p -> Map.<String, Object>of(
                        ...
                        "planName", p.getServicePlan() != null ? p.getServicePlan().getName() : "Custom",
                        "amount", p.getAmount(),
        ...
        return Map.of(
                "kpi", Map.of(
                        ...
                        "activeSubscriptions", planDistribution.values().stream().mapToLong(Long::longValue).sum()
                ),
                "charts", Map.of(
