...
@Controller
@RequestMapping("/content-manager/web-content/pages")
@RequiredArgsConstructor
@Slf4j
public class ContentManagerWebContentStaticPageController {
    ...
    public String edit(@PathVariable String pageType, Model model) {
        ...
        return "content-manager/web-content/pages/edit";
    }
    ...
    public String update(
        ...
        try {
            ...
            return "redirect:/content-manager/web-content?tab=static-pages";
